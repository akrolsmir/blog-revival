    ...
    <main>
      ...
      <section id="how" className="bg-parchment px-6 py-24 text-[#2a3040] md:px-12">
        <div className="mx-auto max-w-[1060px]">
          <div className="mb-16 text-center">
            <p className="gy-caps text-[13px] tracking-[0.32em] text-[#8a7f5f]">
              the mechanism
            </p>
            <h2 className="mt-3 text-4xl text-[#232838] md:text-[46px]">
              How a revival works
            </h2>
            <p className="mx-auto mt-4 max-w-[540px] text-lg text-[#5d6377] [text-wrap:pretty]">
              Quadratic funding, a {dollars(poolCents, { round: true })}{" "}
              matching pool, and one simple ask: a single substantive post,
          ...
          <div className="grid gap-11 md:grid-cols-3">
            {[
              ...
              <div key={step.numeral} className="flex flex-col gap-3.5">
                ...
                <h3 className="text-[25px] font-semibold text-[#232838]">
                  {step.title}
                </h3>
                <p className="leading-[1.6] text-[#565c70] [text-wrap:pretty]">
                  {step.body}
                </p>
              </div>
            ))}
      ...
      <section id="match" className="px-6 py-20 md:px-12">
        <div className="mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-2">
          <div>
            <p className="gy-caps text-[13px] tracking-[0.32em] text-mist">
              the séance
            </p>
      ...
      <section id="blogroll" className="px-6 pb-28 pt-6 md:px-12">
        ...
        {isLoading ? (
          <p className="gy-caps mt-16 text-center tracking-[0.2em] text-mist">
            raising the dead…
          </p>
        ) : (
